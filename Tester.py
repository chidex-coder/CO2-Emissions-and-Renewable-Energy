...
# Streamlit UI
# --------------------------
st.set_page_config(page_title="Chiagoziem's Advanced Emissions & Renewables Analytics", layout="wide")
st.title("🌍 Chiagoziem's Advanced Emissions & Renewables Analytics Platform")
...
st.markdown(
    ...
    <div style="text-align: center; padding: 20px; color: #666;">
        <h4>🌍 Chiagoziem's Advanced Emissions & Renewables Analytics Platform</h4>
